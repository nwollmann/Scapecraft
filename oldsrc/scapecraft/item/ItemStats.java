	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world,
...

		{
			...
			if (world.isRemote){
				...
				else if (propsa.getMiningxp() >= 404108) {	entityplayer.addChatMessage("Your current mining level is 50, and your current xp is "+String.valueOf(propsa.getMiningxp())+" You have maxed out this level!");}		
