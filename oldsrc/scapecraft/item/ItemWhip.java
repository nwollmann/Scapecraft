...
public class ItemWhip extends ItemSword
{
	...
	public ItemWhip(int par1, ToolMaterial par2EnumToolMaterial)
	{
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		...
		if (props.getEnergy() >  5000){
			...
			if (par2World.isRemote){
				par3EntityPlayer.addChatMessage(new ChatComponentText("\u00a7ESpecial Activated"));
			}}

		else
		{
			if (par2World.isRemote){par3EntityPlayer.addChatMessage(new ChatComponentText("\u00a7EYou have " + String.valueOf(props.getEnergy()/100) + "%% Special Attack Energy, 50%% is needed"));
			}}
