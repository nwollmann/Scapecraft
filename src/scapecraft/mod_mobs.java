...
import scapecraft.proxy.TestClientProxy;
import scapecraft.proxy.TestCommonProxy;
	...
	public class mod_mobs
{
	...
	@SidedProxy(clientSide="scapecraft.proxy.TestClientProxy", serverSide="scapecraft.proxy.TestCommonProxy") 
