...
public class EntityDwarf extends EntityScapecraft
{
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(0.650D);
	...
	{
		Minecraft.getMinecraft().thePlayer.addChatComponentMessage(new ChatComponentText("\u00a7EDwarf: Can't talk now, busy mining"));
