...
public class EntityHillGiant extends EntityScapecraft
{
	...
	protected void dropFewItems(boolean par1, int par2){
		...
		int quickvar10 = rand.nextInt(60) + 1;
		...
		if(quickvar4 <= 1){entityDropItem(new ItemStack(Scapecraft.blackHelmet), 1);}
	...
	{
		Minecraft.getMinecraft().thePlayer.addChatComponentMessage(new ChatComponentText("\u00a7EHill Giant: Smash!"));
