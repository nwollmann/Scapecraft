...
public enum ScapecraftToolMaterial
{
	...
	CHAOTIC(3, 5000, 15.0F, 7.0F, 30),
	GALOREG(3, 500, 100.0F, 7.0F, 30),
	KORASIS(3, 100, 5.0F, 8.0F, 10),
	DRAGON(3, 2500, 15.0F, 5.0F, 30),
	DRAGONC(3, 250, 15.0F, 7.0F, 30),	 
	BLACK(2, 300, 6.0F, 2.0F, 15),
	BLACKH(2, 1500, 6.0F, 3.0F, 15),
	AGS(3, 30000, 15.0F, 16.0F, 30),
	BGS(3, 30000, 15.0F, 14.0F, 30),
	SGS(3, 30000, 15.0F, 14.0F, 30),
	ZGS(3, 30000, 15.0F, 14.0F, 30),
	SS(3, 30000, 15.0F, 10.0F, 30),
	CHICKEN(3, 15000000, 15.0F, -4.0F, 100),
	KERIS(3, 15000000, 15.0F, 6.0F, 40),
	...
	FREM(3, 1000, 15.0F, 7.0F, 5),
	FREMF(3, 30000, 15.0F, 12.0F, 5),
	...
	DHAROK(3, 10000, 15.0F, 9.0F, 8),
	AHRIM(3, 10000, 15.0F, 8.0F, 8),
	AKRISAE(3, 10000, 15.0F, 9.0F, 8);
