...
public enum ScapecraftToolMaterial
{
	...
	MITH(2, 400, 6.5F, 3.0F, 10, 5),
	ADDY(2, 700, 7.5F, 4.0F, 10, 10),
	RUNE(3, 2000, 10.5F, 5.0F, 10, 15),
	...
	AGS(3, 30000, 15.0F, 17.0F, 30, 30),
	BGS(3, 30000, 15.0F, 15.0F, 30, 30),
	SGS(3, 30000, 15.0F, 15.0F, 30, 30),
	ZGS(3, 30000, 15.0F, 15.0F, 30, 30),
	SS(3, 30000, 15.0F, 11.0F, 30, 25),
	...
	CHAOTIC(3, 30000, 15.0F, 15.0F, 30, 30),
	MAUL(3, 30000, 15.0F, 22.0F, 30),	 
	DRAGOND(3, 2500, 15.0F, 4.0F, 30, 20),
	DRAGONDS(3, 2500, 15.0F, 4.0F, 30, 20),
	DRAGONB(3, 2500, 15.0F, 9.0F, 30, 20),
	DRAGONS(3, 2500, 15.0F, 8.0F, 30, 20),
	WHIP(3, 30000, 15.0F, 10.0F, 30, 25),
	...
	TORAG(3, 10000, 15.0F, 12.0F, 8, 30),
	VERAC(3, 10000, 15.0F, 8.0F, 8, 30),
	GUTHAN(3, 10000, 15.0F, 9.0F, 8, 30),
	DHAROK(3, 10000, 15.0F, 10.0F, 8, 30),
	AHRIM(3, 10000, 15.0F, 9.0F, 8, 30),
	AKRISAE(3, 10000, 15.0F, 10.0F, 8, 30);
