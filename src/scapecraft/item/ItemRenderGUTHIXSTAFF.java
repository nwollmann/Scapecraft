...
import net.minecraft.scapecraft.item.models.DBA;
import net.minecraft.scapecraft.item.models.ModelRapier;
import net.minecraft.scapecraft.item.models.ModelGuthixstaff;
