...
public class You_Must_Update_Scapecraft extends BaseMod {
	...
	//public static final Item scapecraft.proxy = new Itemscapecraft.proxy(11112).setUnlocalizedName("mod_lightning:rocket");
...

	{
		...
		//ModLoader.addName(scapecraft.proxy, "Rocket Pack");
		...
		//GameRegistry.addRecipe(new ItemStack(mod_lightning.scapecraft.proxy),new Object[] { "XX", 'X', Block.bedrock });
	}
